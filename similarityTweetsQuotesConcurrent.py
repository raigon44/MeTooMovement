...
class MeasureSimilarity:
    ...
    def compute_similarity_parallel(self, speaker):
        # This function calls the methods to compute the similarity for the given speaker.
        # And it returns a frame containing all the quotes by that author with the distance to the most similar tweet.
